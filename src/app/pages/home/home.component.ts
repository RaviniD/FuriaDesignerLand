...
@Component({
  selector: 'app-home',
  imports: [OrceButtonComponent, CardPopListComponent, LogoCarouselComponent, SlideInfoComponent, CardPortListComponent, CardFeedbackListComponent, FooterComponent],
